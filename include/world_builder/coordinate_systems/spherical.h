  ...
  namespace CoordinateSystems
  {
    ...
    class Spherical : public Interface
    {
      public:
        ...
        /**
         * Returns what the natural coordinate system for this Coordinate System
         * is.
         */
         ...
         * latitude) in 3d.
         */
        std::array<double, 3> cartesian_to_natural_coordinates(
          const std::array<double, 3> &position) const override final;
         ...
         */
        std::array<double, 3> natural_to_cartesian_coordinates(
          const std::array<double, 3> &position) const override final;
         ...
         */
        double distance_between_points_at_same_depth(
          const Point<3> &point_1,
          const Point<3> &point_2) const override final;
