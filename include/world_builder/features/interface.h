...
namespace WorldBuilder
{
  ...
  namespace Features
  {
    ...
    /**
     * This class is an interface for the specific plate tectonic feature
     * classes, such as continental plate, oceanic plate and subduction zone.
     */
    class Interface
    {
      public:
         ...
         * depricated
         */
        void declare_interface_entries(Parameters &prm,
                                       const CoordinateSystem coordinate_system);
        /**
         * helper function to parse coordinates.
         */
        void get_coordinates(const std::string &name, Parameters &prm,
                             const CoordinateSystem coordinate_system);
         ...
         */
        virtual double temperature(const Point<3> &position, const double depth,
         ...
         */
        virtual double composition(const Point<3> &position, const double depth,
         ...
         */
        virtual WorldBuilder::grains grains(const Point<3> &position,
                                            const double depth,
                                            const unsigned int composition_number,
      ...
      protected:
        ...
        /**
         * The type of interpolation used to get the line position between the
         * points.
         */
      ...
      private:
        ...
        static std::map<std::string, void (*)(Parameters &, const std::string &,
