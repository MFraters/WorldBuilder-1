...
namespace WorldBuilder
{
  ...
  namespace Features
  {
    ...
    OceanicPlate::~OceanicPlate() = default;
    ...
    OceanicPlate::declare_entries(Parameters &prm,
      ...
      prm.declare_entry(
          "temperature models",
          Types::PluginSystem("",
                              Features::OceanicPlateModels::Temperature::
      ...
      prm.declare_entry(
          "composition models",
          Types::PluginSystem("",
                              Features::OceanicPlateModels::Composition::
                                  Interface::declare_entries,
                              {"model"}),
      ...
      prm.declare_entry(
          ...
          Types::PluginSystem(
              "",
              Features::OceanicPlateModels::Grains::Interface::declare_entries,
              {"model"}),
          "A list of grains models.");
    }

    void OceanicPlate::parse_entries(Parameters &prm) {
      ...
      prm.get_unique_pointers<Features::OceanicPlateModels::Grains::Interface>(
    ...
    double OceanicPlate::temperature(const Point<3> &position,
                                     const double depth,
    ...
    double OceanicPlate::composition(const Point<3> &position,
                                     const double depth,
    ...
    WorldBuilder::grains
    OceanicPlate::grains(const Point<3> &position, const double depth,
                         const unsigned int composition_number,
