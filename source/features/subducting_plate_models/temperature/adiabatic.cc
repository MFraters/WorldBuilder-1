  ...
  namespace Features
  {
    namespace SubductingPlateModels
    {
      namespace Temperature
      {
        ...
        void Adiabatic::declare_entries(Parameters &prm,
                                        const std::string & /*unused*/)
        {

          // Add temperature to the required parameters.
          // prm.declare_entry("", Types::Object({"temperature"}), "Temperature
          // model object");
          ...
          prm.declare_entry(
            "specific heat", Types::Double(-1),
            "The specific heat in $J kg^{-1} K^{-1}$. "
            "If the value is lower then zero, the global value is used.");
        }

        void Adiabatic::parse_entries(Parameters &prm)
        {
          ...
          WBAssert(!std::isnan(potential_mantle_temperature),
                   "potential_mantle_temperature is not a number: "
                   << potential_mantle_temperature << ".");
          WBAssert(std::isfinite(potential_mantle_temperature),
                   "potential_mantle_temperature is not a finite: "
                   << potential_mantle_temperature << ".");

          WBAssert(!std::isnan(thermal_expansion_coefficient),
                   "thermal_expansion_coefficient is not a number: "
                   << thermal_expansion_coefficient << ".");
          WBAssert(std::isfinite(thermal_expansion_coefficient),
                   "thermal_expansion_coefficient is not a finite: "
                   << thermal_expansion_coefficient << ".");
        ...
        double Adiabatic::get_temperature(
          ...
          const std::map<std::string, double> &distance_from_planes) const
        {
          ...
          if (distance_from_plane <= max_depth &&
            ...
            {
              const double adabatic_temperature =
                potential_mantle_temperature *
              ...
              WBAssert(!std::isnan(adabatic_temperature),
                       "adabatic_temperature is not a number: "
                       << adabatic_temperature << ". "
                       << "Parameters: potential_mantle_temperature = "
                       << potential_mantle_temperature
                       << ", thermal_expansion_coefficient = "
                       << thermal_expansion_coefficient
              ...
              WBAssert(std::isfinite(adabatic_temperature),
                       "adabatic_temperature is not a finite: "
                       << adabatic_temperature << ".");
        ...
        WB_REGISTER_FEATURE_SUBDUCTING_PLATE_TEMPERATURE_MODEL(Adiabatic,
                                                               adiabatic)
      } // namespace Temperature
    }   // namespace SubductingPlateModels
  }     // namespace Features
