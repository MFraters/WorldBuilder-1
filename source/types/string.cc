...
namespace WorldBuilder
{
  namespace Types
  {
    ...
    String::String(std::string default_value_)
      : default_value(std::move(default_value_)), description(""),
      restricted_values({})
    {
    ...
    String::String(std::string value_, std::string default_value_,
                   std::string description_)
      : value(std::move(value_)), default_value(std::move(default_value_)),
    ...
    void String::write_schema(Parameters &prm, const std::string &name,
                              const std::string &documentation) const
    {
      ...
      .Set(declarations, default_value.c_str());
