...
namespace WorldBuilder
{
  ...
  namespace Types
  {
    Contours::Contours(const double default_length_,
    ...
    {
      this->type_name = Types::type::Contours;
    }


    Contours::Contours(Contours const &other)
      :
    ...
    void
    Contours::write_schema(Parameters &prm,
  ...
  /*namespace Objects
  {
    ...
    contours<A,B,C>::contours(const double default_length_,
                            const WorldBuilder::Point<2> &default_thickness_,
                            const WorldBuilder::Point<2> &default_top_truncation_,
                            const WorldBuilder::Point<2> &default_angle_,
    ...
    template<class A, class B, class C>
    contours<A,B,C>::contours(contours const &other)
      :
    ...
    template<class A, class B, class C>
    void
    contours<A,B,C>::write_schema(Parameters & / *prm* /,
                                 const std::string & / *name* /,
                                 const std::string & / *documentation* /) const
    {
